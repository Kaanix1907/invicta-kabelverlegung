...
function initFrameSequence() {
  ...
  // Logo element
  const sequenceLogo = document.getElementById('sequenceLogo');

  // --- Annotation card show/hide + logo reveal ---
  function updateCards(progress) {
    ...
    // Show logo when animation reaches ~85%
    if (sequenceLogo) {
      sequenceLogo.classList.toggle('visible', progress >= 0.85);
    }
  }
