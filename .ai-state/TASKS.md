...
- [ ] Formular-Backend (Formspree o.ä.)
...
- [x] INVICTA Schriftzug (position: absolute, erscheint bei 85%)
- [x] Background auf #eaeaea (hell, nicht dunkel)
- [x] Mobile-Responsive Optimierung
